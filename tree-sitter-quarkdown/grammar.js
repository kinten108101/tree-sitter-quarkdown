...
module.exports = grammar({
    ...
    rules: {
        ...
        qcmd_param: $ => prec(1, choice($.qcmd_param_singlevalue, $.qcmd_param_keyvaluepair)),

        _qcmd_param_value_content: $ => choice($.numberval, alias($._line0, $.otherval)),

        numberval: $ => choice(/[0-9]/, /[1-9][0-9]+/),

        qcmd_param_singlevalue: $ => prec(1, seq(
            '{', alias($._qcmd_param_value_content, $.qcmd_param_value), '}' 
        )),

        qcmd_param_keyvaluepair: $ => prec(1, seq(
            alias($._word, $.qcmd_param_key), ':', '{', alias($._qcmd_param_value_content, $.qcmd_param_value), '}' 
        )),
        ...
        _line0: $ => prec.right(repeat1(choice($._word, $._whitespace))),
        _word: $ => choice(
