...
TSLanguage *tree_sitter_quarkdown(void);

TSLanguage *tree_sitter_quarkdown_inline(void);

static PyObject* _binding_language(PyObject *Py_UNUSED(self), PyObject *Py_UNUSED(args)) {
    return PyCapsule_New(tree_sitter_quarkdown(), "tree_sitter.Language", NULL);
}

static PyObject* _binding_inline_language(PyObject *Py_UNUSED(self), PyObject *Py_UNUSED(args)) {
    return PyCapsule_New(tree_sitter_quarkdown_inline(), "tree_sitter.Language", NULL);
}
